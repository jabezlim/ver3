(function () {
    ...
    function PaymentListCtrl($scope, $http, $routeParams, $filter, $rootScope, $timeout, $location, Order) {
        ...
        function paycocancel(payment) {
            var apipath = Order.payco.apipath; //"https://alpha-dongle.payco.com";
            var tidcode = payment.param1+Order.PaycoInfo.posTid;
            ...
            var data1 = {
                ...
                data : {
                    ...
                    approvalNo : payment.appno,
                    approvalDatetime : payment.saledate+payment.saletime,
        ...
        $scope.cardcancel = function(payment) {  			
            ...
            if (payment.appno != '') {                
                ...
                if (payment.cardtype=="현금") {
                    ...
                    else if (Number(payment.checked_by)==18) { // payco
                        ocxlog('페이코취소');
                        $scope.bnoPopup = true;
                        paycocancel(payment);
                        return ;
